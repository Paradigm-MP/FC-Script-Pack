...
function WarpGui:__init()
	...
	-- Admins
	self:AddAdmin("STEAM_0:1:31147722") --lf
	self:AddAdmin("STEAM_0:1:82883843") --dev
	self:AddAdmin("STEAM_0:0:101492030") --tsj
	self:AddAdmin("STEAM_0:1:104062218") --doc
	self:AddAdmin("STEAM_0:0:70097808") --doc
	self:AddAdmin("STEAM_0:1:26212820") --epies
...
function WarpGui:KeyUp( args )
    if args.key == string.byte('V') and (LocalPlayer:GetValue("NT_TagName") == "[Admin]" or LocalPlayer:GetValue("NT_TagName") == "[Mod]") then
        self:SetWindowVisible(not self.windowShown)
    end
end
