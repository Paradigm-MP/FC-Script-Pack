...
function Notifications:__init()
	...
	Network:Subscribe("SendNotification", self, self.GetNotification)
...
function Notifications:Render()
	...
	if SubTxt ~= nil then
		Render:DrawText(Vector2((Render.Width - 107.5 ) - (Render:GetTextWidth(MainTxt, 15) / 2), 46), MainTxt, Color(210,210,210,TxtAlpha), 15)
		Render:DrawText(Vector2((Render.Width - 107.5 ) - (Render:GetTextWidth(SubTxt, 12) / 2), 63), SubTxt, Color(140,140,140,TxtAlpha), 12)
	else
		Render:DrawText(Vector2((Render.Width - 107.5 ) - (Render:GetTextWidth(MainTxt, 15) / 2), 54), MainTxt, Color(210,210,210,TxtAlpha), 15)
	end
